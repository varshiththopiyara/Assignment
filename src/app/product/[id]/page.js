  ...
  if (!product) {
    return (
      <Container className="py-4 py-md-5 text-center">
        <h2 className="mb-3" style={{ fontFamily: 'Lato, sans-serif', fontWeight: 700, fontSize: 'clamp(1.5rem, 4vw, 2.5rem)' }}>
          Product Not Found
        </h2>
        <p style={{ color: 'rgba(255,255,255,0.3)', fontFamily: 'Lato, sans-serif', fontSize: 'clamp(0.9rem, 2vw, 1.1rem)' }}>
      ...
      <div className="product-detail-wrapper">
        <Row className="g-3 g-md-4">
          ...
          <Col xs={12} lg={6}>
            ...
            {product.rating && (
              <div className="d-flex align-items-center gap-2 gap-md-3 mb-4">
                ...
                <span style={{ 
                  ...
                  <strong style={{ color: '#ffffff' }}>{product.rating.rate}</strong> / 5 ({product.rating.count} reviews)
                </span>
              </div>
            )}
            
            <h5 className="mt-3 mt-md-4 fw-semibold" style={{ 
              fontFamily: 'Lato, sans-serif', 
              fontWeight: 700,
            ...
            <div className="mt-3 mt-md-4 pt-3" style={{ borderTop: '1px solid rgba(255,255,255,0.06)' }}>
              <Button 
                variant="light" 
                size="lg" 
                className="px-4 px-md-5 py-2 fw-bold w-100 w-md-auto"
                style={{
                  borderRadius: '50px',
                  fontFamily: 'Lato, sans-serif',
                  fontWeight: 700,
